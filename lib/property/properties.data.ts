...
export const APP_PROPERTIES: StatePropertyOptions[] = [
    { clientKey: "power", vendorKey: 'Pow', valuesRelationship: { 'off': 0, 'on': 1 } },
    { clientKey: "mode", vendorKey: 'Mod', valuesRelationship:
            { 'auto': 0, 'cool': 1, 'dry': 2, 'fan_only': 3, 'heat': 4 }
    },
    { clientKey: "temperatureUnit", vendorKey: 'TemUn', valuesRelationship:
            { 'celsius': 0, 'fahrenheit': 1 }
    },
    { clientKey: "fanSpeed", vendorKey: 'WdSpd', valuesRelationship:
            { 'auto': 0, 'low': 1, 'mediumLow': 2, 'medium': 3, 'mediumHigh': 4, 'high': 5 }
    },
    { clientKey: "air", vendorKey: 'Air', valuesRelationship:
            { 'off': 0, 'inside': 1, 'outside': 2, 'mode3': 3 } },
